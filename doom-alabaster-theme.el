...
;;;; Colors
  ...
  ((bg           '("#000000" "#000000"   "black"))
   ...
   (grey-comment '("#696969" "#696969"   "grey"))
   ...
   (dark-cyan    '("#47BEA9" "#47BEA9"   "cyan"))
   (light-yellow '("#DFDF8E" "#DFDF8E"   "brightyellow"))
   (orange       '("#EC8013" "#EC8013"   "brightred"))
   (teal         '("#6ABF40" "#6ABF40"   "brightgreen"))
